...
def transform_to_train(model, pre_neuron, post_neuron):
    with model:
        ...
        pre_train_sig_conn = nengo.Connection(train_signal_generator, pre_neuron, synapse = 0.005)
        post_train_sig_conn = nengo.Connection(train_signal_generator, post_neuron, synapse = 0.005+Dij)
    return model
